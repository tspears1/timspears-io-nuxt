...
const isHoveredOpenedMotion = () => {
    animate(gridRef.barsOpened, { scaleX: [0, 1], scaleY: [0, 1], opacity: 0.4 }, { delay: stagger(0.15), duration: .5 })
}

const isHoveredClosedMotion = () => {
    animate(gridRef.barsClosed, { scaleX: [0, 1], opacity: 0.4 }, { delay: stagger(0.075), duration: .25 })
}
